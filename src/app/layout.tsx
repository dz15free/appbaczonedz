...
/* ملء الشاشة الحقيقي على iPhone لا يوجد داخل Safari بأيّ واجهة
   برمجية (انظر `lib/fullscreen.ts`). طريقه الوحيد هو التثبيت على
   الشاشة الرئيسية — وهذه الوسوم هي ما يجعل التثبيت يعمل بلا واجهة
   متصفّح. كانت ناقصة، فحتّى من ثبّت التطبيق كان يحصل على شريط
   Safari داخله. */
