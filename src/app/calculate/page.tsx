...
const TITLE = "حساب معدل البكالوريا 2026 جميع الشعب | حاسبة معدل الباك بعد تعديلات الوزارة";
const DESC =
  "حساب معدل البكالوريا 2026 بدقة لجميع الشعب (علوم تجريبية، رياضيات، تقني رياضي، تسيير واقتصاد، آداب وفلسفة، لغات أجنبية) وفق المعاملات الجديدة لوزارة التربية. حساب معدل الباك مجاناً وبدقة — بلا تسجيل.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESC,
  keywords: [
    "حساب معدل البكالوريا", "حساب معدل الباك", "حساب معدل البكالوريا 2026", "حاسبة معدل الباك",
    ...
    "حساب معدل البكالوريا شعبة لغات أجنبية", "حساب معدل البكالوريا تقني رياضي",
    "حاسبة معدل البكالوريا بعد تعديلات الوزارة", "معاملات البكالوريا 2026", "حساب معدل البكالوريا بعد تغييرات الوزارة",
    "بكالوريا 2026", "BacZone",
  ],
...
const FAQ = [
  ...
  },
  {
    ...
    a: "نعم، حاسبة BacZone محدثة وفق آخر التعديلات الصادرة عن وزارة التربية الوطنية لمعاملات بكالوريا 2026 لجميع الشعب.",
  },
  {
    q: "هل يمكن حساب المعدل لجميع الشعب؟",
    a: "نعم، تتوفر حاسبة منفصلة لكل شعبة: علوم تجريبية، رياضيات، تقني رياضي، تسيير واقتصاد، آداب وفلسفة، ولغات أجنبية.",
  },
  {
