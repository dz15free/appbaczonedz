...
const features = [
  ...
  { icon: faRobot, title: "Omibot — مساعدك الذكي", desc: "يطرح أسئلة توضيحية، يضع خطط مراجعة مخصّصة حسب شعبتك، ويطمئنك ويشجّعك." },
...
const steps = [
  ...
  { n: "03", title: "تعلّم، شارك، وتقدّم", desc: "استخدم السبورة والصوت وOmibot، واكسب النقاط لترقى في الترتيب." },
];
