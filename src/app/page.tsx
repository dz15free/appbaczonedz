        ...
        <div className="relative mx-auto grid min-h-[min(760px,100svh)] max-w-6xl items-center gap-12 px-5 pb-24 pt-32 sm:px-6 lg:grid-cols-[1.08fr_.92fr] lg:gap-16 lg:pb-28 lg:pt-40">
          ...
          <div className="relative mx-auto hidden w-full max-w-md lg:block" aria-hidden="true">
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.06] p-5 shadow-2xl shadow-blue-950/40 backdrop-blur-xl">
              <div className="flex items-center justify-between border-b border-white/10 pb-4"><span className="text-xs font-bold text-white/50">مساحة الدراسة</span><span className="flex items-center gap-1.5 text-[11px] text-emerald-300"><i className="h-2 w-2 rounded-full bg-emerald-300" /> متصل الآن</span></div>
              <div className="mt-5 grid grid-cols-2 gap-3">
                <div className="rounded-2xl bg-blue-500/15 p-4"><FontAwesomeIcon icon={faBookOpen} className="h-5 w-5 text-blue-300" /><p className="mt-5 text-2xl font-black text-white">أدوات</p><p className="mt-1 text-xs text-white/45">تحسب وتخطط وتراجع</p></div>
                <div className="rounded-2xl bg-emerald-500/15 p-4"><FontAwesomeIcon icon={faUsers} className="h-5 w-5 text-emerald-300" /><p className="mt-5 text-2xl font-black text-white">مجتمع</p><p className="mt-1 text-xs text-white/45">طلاب وأساتذة</p></div>
              </div>
              <div className="mt-3 rounded-2xl border border-white/10 bg-black/10 p-4"><div className="flex items-center justify-between text-xs text-white/55"><span>خطة هذا الأسبوع</span><span className="text-emerald-300">تقدّم مستمر</span></div><div className="mt-4 h-2 overflow-hidden rounded-full bg-white/10"><div className="h-full w-[68%] rounded-full bg-gradient-to-l from-blue-400 to-emerald-300" /></div></div>
            </div>
          </div>
        </div>
