/* ════════════════════════════════════════════════════════════
   ...
   كانت الحالة تُعرض برموز تعبيرية (🟢🔴🟡). الرمز التعبيري يُرسم
   بخطّ النظام، فيختلف حجمه ولونه وحوافّه بين أندرويد و iOS
   وويندوز، ولا يمكن ضبط مقاسه مع بقيّة السطر. النقطة هنا عنصر
   حقيقي بألوان نظام تصميم BacZone، متطابقة على كل جهاز.

   اللون وحده لا يكفي للمستخدم الذي لا يميّز الألوان، لذلك تحمل
   النقطة دائماً aria-label نصّياً، ويمكن إظهار التسمية بجانبها.
════════════════════════════════════════════════════════════ */
