...
export const TRACKS: CurriculumTrack[] = [
  {"id": "isl-common", "subject": "العلوم الإسلامية", "streams": ["علوم تجريبية", "رياضيات", "تقني رياضي", "هندسة ميكانيكية", "هندسة كهربائية", "هندسة مدنية", "هندسة الطرائق", "تسيير واقتصاد", "آداب وفلسفة", "لغات أجنبية"], "note": "برنامج واحد لكل الشعب — قُورنت الدروس فلم يظهر فرق."},
  {"id": "hisgeo-common", "subject": "التاريخ والجغرافيا", "streams": ["علوم تجريبية", "رياضيات", "تقني رياضي", "هندسة ميكانيكية", "هندسة كهربائية", "هندسة مدنية", "هندسة الطرائق", "تسيير واقتصاد", "آداب وفلسفة", "لغات أجنبية"], "note": "مادة امتحان واحدة ببرنامج موحّد لكل الشعب."},
  {"id": "fr-common", "subject": "اللغة الفرنسية", "streams": ["علوم تجريبية", "رياضيات", "تقني رياضي", "هندسة ميكانيكية", "هندسة كهربائية", "هندسة مدنية", "هندسة الطرائق", "تسيير واقتصاد", "آداب وفلسفة", "لغات أجنبية"], "note": "وثيقة التدرّج السنوي للفرنسية تشمل الشعب الستّ بالبرنامج نفسه."},
  {"id": "en-common", "subject": "اللغة الإنجليزية", "streams": ["علوم تجريبية", "رياضيات", "تقني رياضي", "هندسة ميكانيكية", "هندسة كهربائية", "هندسة مدنية", "هندسة الطرائق", "تسيير واقتصاد", "آداب وفلسفة", "لغات أجنبية"], "note": "الوحدات الأربع نفسها في كل الشعب."},
...
export const OFFICIAL_STREAMS: string[] = ["علوم تجريبية", "رياضيات", "تقني رياضي", "هندسة ميكانيكية", "هندسة كهربائية", "هندسة مدنية", "هندسة الطرائق", "تسيير واقتصاد", "آداب وفلسفة", "لغات أجنبية"];
...
export const STREAM_COVERAGE: Record<string, "full" | "partial"> = {
  ...
  "رياضيات": "partial",
  "تقني رياضي": "partial",
  "هندسة ميكانيكية": "partial",
  "هندسة كهربائية": "partial",
  "هندسة مدنية": "partial",
  "هندسة الطرائق": "partial",
