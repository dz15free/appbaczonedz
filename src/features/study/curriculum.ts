...
export interface CurriculumTrack {
  ...
  streams: string[];
  /** لماذا هذه النسخة مستقلّة عن غيرها في المادة نفسها */
  note?: string;
}
...
export const TRACKS: CurriculumTrack[] = [
  ...
  {"id": "fr-common", "subject": "اللغة الفرنسية", "streams": ["علوم تجريبية", "رياضيات", "تقني رياضي", "تسيير واقتصاد", "آداب وفلسفة", "لغات أجنبية"], "note": "وثيقة التدرّج السنوي للفرنسية تشمل الشعب الستّ بالبرنامج نفسه."},
  {"id": "en-common", "subject": "اللغة الإنجليزية", "streams": ["علوم تجريبية", "رياضيات", "تقني رياضي", "تسيير واقتصاد", "آداب وفلسفة", "لغات أجنبية"], "note": "الوحدات الأربع نفسها في كل الشعب."},
  ...
  {"id": "math-math", "subject": "الرياضيات", "streams": ["رياضيات"], "note": "برنامج مستقلّ يبدأ بالحساب في Z — لا يشترك مع علوم تجريبية في أيّ درس."},
  ...
  {"id": "phy-math", "subject": "العلوم الفيزيائية", "streams": ["رياضيات"], "note": "برنامج مستقلّ — الاهتزازات لا ترد في برنامج علوم تجريبية."},
  {"id": "svt-sci", "subject": "علوم الطبيعة والحياة", "streams": ["علوم تجريبية"]},
  {"id": "phi-lit", "subject": "الفلسفة", "streams": ["آداب وفلسفة"], "note": "برامج الفلسفة تصدر منفصلة حسب الشعبة — هذه نسخة آداب وفلسفة."},
  {"id": "ara-lit", "subject": "اللغة العربية وآدابها", "streams": ["آداب وفلسفة"], "note": "للشعب العلمية وثيقة تدرّج مستقلّة ببرنامج مختلف."},
  ...
  {"id": "ara-sci", "subject": "اللغة العربية وآدابها", "streams": ["علوم تجريبية"], "note": "المادّة معتمدة في هذه الشعبة، ودروسها لم تُدخَل بعد."},
  {"id": "phi-sci", "subject": "الفلسفة", "streams": ["علوم تجريبية"], "note": "المادّة معتمدة في هذه الشعبة، ودروسها لم تُدخَل بعد."},
  {"id": "svt-math", "subject": "علوم الطبيعة والحياة", "streams": ["رياضيات"], "note": "المادّة معتمدة في هذه الشعبة، ودروسها لم تُدخَل بعد."},
  {"id": "ara-math", "subject": "اللغة العربية وآدابها", "streams": ["رياضيات"], "note": "المادّة معتمدة في هذه الشعبة، ودروسها لم تُدخَل بعد."},
  {"id": "phi-math", "subject": "الفلسفة", "streams": ["رياضيات"], "note": "المادّة معتمدة في هذه الشعبة، ودروسها لم تُدخَل بعد."},
  {"id": "tech-tech", "subject": "التكنولوجيا", "streams": ["تقني رياضي"], "note": "المادّة معتمدة في هذه الشعبة، ودروسها لم تُدخَل بعد."},
  {"id": "math-tech", "subject": "الرياضيات", "streams": ["تقني رياضي"], "note": "المادّة معتمدة في هذه الشعبة، ودروسها لم تُدخَل بعد."},
  {"id": "phy-tech", "subject": "العلوم الفيزيائية", "streams": ["تقني رياضي"], "note": "المادّة معتمدة في هذه الشعبة، ودروسها لم تُدخَل بعد."},
  {"id": "ara-tech", "subject": "اللغة العربية وآدابها", "streams": ["تقني رياضي"], "note": "المادّة معتمدة في هذه الشعبة، ودروسها لم تُدخَل بعد."},
  {"id": "phi-tech", "subject": "الفلسفة", "streams": ["تقني رياضي"], "note": "المادّة معتمدة في هذه الشعبة، ودروسها لم تُدخَل بعد."},
  {"id": "math-eco", "subject": "الرياضيات", "streams": ["تسيير واقتصاد"], "note": "المادّة معتمدة في هذه الشعبة، ودروسها لم تُدخَل بعد."},
  {"id": "ara-eco", "subject": "اللغة العربية وآدابها", "streams": ["تسيير واقتصاد"], "note": "المادّة معتمدة في هذه الشعبة، ودروسها لم تُدخَل بعد."},
  {"id": "phi-eco", "subject": "الفلسفة", "streams": ["تسيير واقتصاد"], "note": "المادّة معتمدة في هذه الشعبة، ودروسها لم تُدخَل بعد."},
  {"id": "math-lit", "subject": "الرياضيات", "streams": ["آداب وفلسفة"], "note": "المادّة معتمدة في هذه الشعبة، ودروسها لم تُدخَل بعد."},
  {"id": "ara-lang", "subject": "اللغة العربية وآدابها", "streams": ["لغات أجنبية"], "note": "المادّة معتمدة في هذه الشعبة، ودروسها لم تُدخَل بعد."},
  {"id": "phi-lang", "subject": "الفلسفة", "streams": ["لغات أجنبية"], "note": "المادّة معتمدة في هذه الشعبة، ودروسها لم تُدخَل بعد."},
  {"id": "math-lang", "subject": "الرياضيات", "streams": ["لغات أجنبية"], "note": "المادّة معتمدة في هذه الشعبة، ودروسها لم تُدخَل بعد."},
];

export const LESSONS: Lesson[] = [
  {"id": "LIT_PHI_U1_L1", "title": "الإحساس والإدراك", "unit": "إدراك العالم الخارجي", "track": "phi-lit", "order": 1, "trimester": 1},
  {"id": "LIT_PHI_U1_L2", "title": "اللغة والفكر", "unit": "إدراك العالم الخارجي", "track": "phi-lit", "order": 2, "trimester": 1},
  {"id": "LIT_PHI_U1_L3", "title": "الشعور واللاشعور", "unit": "إدراك العالم الخارجي", "track": "phi-lit", "order": 3, "trimester": 1},
  {"id": "LIT_PHI_U1_L4", "title": "الذاكرة والخيال", "unit": "إدراك العالم الخارجي", "track": "phi-lit", "order": 4, "trimester": 1},
  {"id": "LIT_PHI_U1_L5", "title": "العادة والإرادة", "unit": "إدراك العالم الخارجي", "track": "phi-lit", "order": 5, "trimester": 1},
  {"id": "LIT_PHI_U2_L6", "title": "الأخلاق بين الثوابت والمتغيرات", "unit": "الأخلاق الموضوعية والأخلاق النسبية", "track": "phi-lit", "order": 6, "trimester": 2},
  {"id": "LIT_PHI_U2_L7", "title": "الحقوق والواجبات والعدل", "unit": "الأخلاق الموضوعية والأخلاق النسبية", "track": "phi-lit", "order": 7, "trimester": 2},
  {"id": "LIT_PHI_U2_L8", "title": "العلاقات الأسرية والنظم الاقتصادية (الشغل)", "unit": "الأخلاق الموضوعية والأخلاق النسبية", "track": "phi-lit", "order": 8, "trimester": 2},
  {"id": "LIT_PHI_U2_L9", "title": "الأنظمة السياسية (الدولة)", "unit": "الأخلاق الموضوعية والأخلاق النسبية", "track": "phi-lit", "order": 9, "trimester": 2},
  {"id": "LIT_PHI_U3_L10", "title": "الحقيقة العلمية والحقيقة الفلسفية", "unit": "فلسفة العلوم", "track": "phi-lit", "order": 10, "trimester": 3},
  {"id": "LIT_PHI_U3_L11", "title": "الرياضيات والمطلقية", "unit": "فلسفة العلوم", "track": "phi-lit", "order": 11, "trimester": 3},
  {"id": "LIT_PHI_U3_L12", "title": "العلوم التجريبية والبيولوجية", "unit": "فلسفة العلوم", "track": "phi-lit", "order": 12, "trimester": 3},
  {"id": "LIT_PHI_U3_L13", "title": "العلوم الإنسانية (التاريخ، علم الاجتماع، علم النفس)", "unit": "فلسفة العلوم", "track": "phi-lit", "order": 13, "trimester": 3},
  ...
  {"id": "MATH_MATH_U1_L1", "title": "القسمة في Z", "unit": "الحساب في مجموعة الأعداد الصحيحة", "track": "math-math", "order": 1, "trimester": 1},
  {"id": "MATH_MATH_U1_L2", "title": "الموافقات في Z", "unit": "الحساب في مجموعة الأعداد الصحيحة", "track": "math-math", "order": 2, "trimester": 1},
  {"id": "MATH_MATH_U1_L3", "title": "الأعداد الأولية ومبرهنتا بيزو وغوص", "unit": "الحساب في مجموعة الأعداد الصحيحة", "track": "math-math", "order": 3, "trimester": 1},
  {"id": "MATH_PHY_U7_L19", "title": "الاهتزازات الميكانيكية", "unit": "الاهتزازات", "track": "phy-math", "order": 19, "trimester": 3},
  {"id": "MATH_PHY_U7_L20", "title": "الاهتزازات الكهربائية", "unit": "الاهتزازات", "track": "phy-math", "order": 20, "trimester": 3},
