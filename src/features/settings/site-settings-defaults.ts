...
export const DEFAULTS: SiteSettings = {
  ...
  /* ⚠️ النصّ المطلوب تغييره («انضم لآلاف الطلاب الجزائريين») غير
     موجود في الشيفرة إطلاقاً — بُحث عنه في `src/` و`public/` كلّها.
     فهو إمّا محرَّر من لوحة الإدارة ومخزَّن في `settings` بقاعدة
     البيانات، وإمّا بقيّة نسخة أقدم.

     الصياغة الجديدة هنا هي **الافتراض** الذي يظهر لمن لا سجلّ له في
     `settings`. أمّا الغرف القائمة التي حُرّر نصّها من اللوحة فيبقى
     المخزَّن هو المعروض حتى يُحدَّث من هناك — قاعدة البيانات تعلو
     على الافتراض بحكم التصميم.

     والصياغة تقصد الطموح لا الإحصاء: «نسعى لنكون» وعدٌ يمكن الوفاء
     به، بخلاف «آلاف الطلاب» الذي يدّعي عدداً لا سند له. */
  ctaTitle: "جاهز للانطلاق نحو البكالوريا؟",
  ctaSubtitle: "نسعى لنكون أكبر مجتمع دراسي لطلاب البكالوريا في الجزائر — ابدأ بما تحتاجه اليوم: أداة للحساب أو التخطيط، دليل للمراجعة، أو مساحة دراسة مشتركة.",
